...
print("______ВАРИАНТ С АВТОТЕСТОВ_________________________________________-")
...
print("____МОЙ ВАРИАНТ_______________________________-")
...
for i in arr:
    ...
    elif len(arr) >=4 or len(arr) <=1000:
        res = arr[a-1]+ arr[a-2]+ arr[a-3]
